package functionalProgramming.chapter3.applicative


import functionalProgramming.chapter2.testing.State
import functionalProgramming.chapter2.testing.State._
import functionalProgramming.chapter3.monads.Functor
import functionalProgramming.chapter3.monoid.{Foldable, Monoid}
...
trait Monad[F[_]] extends Applicative[F] with Functor[F] with Traverse[F] {
